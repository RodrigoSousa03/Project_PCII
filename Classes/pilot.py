...
class Pilot(Employee):
    ...
    # code, name, city, phone, NIF, dob, mail, password, username, gender, salary, photo, airplanes, flight_hours
    # for easy copy and paste
    
    def __init__(self, code, name, city, phone, NIF, dob, mail, password, username, gender, salary, photo, airplanes, flight_hours):
        # Object attributes
