...
class Employee(User):
    ...
    # ['code', 'name', 'city', 'phone', 'NIF', 'dob', 'mail', 'password','username', 'gender', 'salary', 'photo']
    # code, name, city, phone, NIF, dob, mail, password, username, gender, salary, photo
    # for easy copy and paste
    
    def __init__(self, code, name, city, phone, NIF, dob, mail, password, username, gender, salary, photo):
        # Object attributes
