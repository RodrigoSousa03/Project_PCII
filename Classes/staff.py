...
class Staff(Employee):
    ...
    # ['code', 'name', 'city', 'phone', 'NIF', 'dob',  'mail', 'password','username', 'gender', 'salary', 'photo', 'role']
    # for easy copy and paste
    
    def __init__(self, code, name, city, phone, NIF, dob, mail, password, username, gender, salary, photo, role):
        # Object attributes
        super().__init__(code, name, city, phone, NIF, dob, mail, password, username, gender, salary, photo)
        self._role = role
...
#     # Creates a customer
#     Staff.read()
#     u1 = Staff("12","manel","rua11","232132","1232","2000-12-31","fghft@gmail.com","mm","234","F",0,"wrer","cleaner")
#     u1.write(path = '')