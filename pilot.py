...
class Pilot(Employee):
    ...
    # code, name, address, phone, NIF, dob, mail, password, username, gender, salary, photo, schedule, airplanes, flight_hours
    # for easy copy and paste
    
    def __init__(self, code, name, address, phone, NIF, dob, mail, password, username, gender, salary, photo, schedule, airplanes, flight_hours):
        # Object attributes
