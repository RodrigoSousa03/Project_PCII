# -*- coding: utf-8 -*-
"""
Created on Mon May 10 09:36:56 2021
...
class Employee(User):
    ...
    # ['code', 'name', 'address', 'phone', 'NIF', 'dob', 'mail', 'password','username', 'gender', 'salary', 'photo', 'schedule']
    # code, name, address, phone, NIF, dob, mail, password, username, gender, salary, photo, schedule
    # for easy copy and paste
    
    def __init__(self, code, name, address, phone, NIF, dob, mail, password, username, gender, salary, photo, schedule):
        # Object attributes
        super().__init__(code, name, address, phone, NIF, dob, mail, password, username, gender)
        self._salary = salary
        self._photo = photo
        self._schedule = schedule
        # Add the new object to the User list
        Employee.obj[code] = self
        Employee.lst.append(code)
